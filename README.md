...
A real-time audio spectrum visualizer that utilizes Fast Fourier Transforms (FFT) to process sound and display frequency band information on a custom-built 70-LED matrix. This project was awarded 1st place in a class-wide engineering competition.
